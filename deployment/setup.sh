...
docker-compose -f compose.infra.yml -p infra pull

# Start the services
echo "Starting services..."
docker-compose -f compose.infra.yml -p infra up -d

echo "Setup complete!"
echo "Access your monitoring infrastructure via the following URLs:"
echo "- Grafana: https://grafana.infra.bitsacco.com"
echo "- Prometheus: https://prometheus.infra.bitsacco.com"
echo "- Alertmanager: https://alertmanager.infra.bitsacco.com"
echo "- Node Exporter: https://node-exporter.infra.bitsacco.com"
echo "- cAdvisor: https://cadvisor.infra.bitsacco.com"
