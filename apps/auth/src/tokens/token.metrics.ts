...
export class TokenMetricsService extends OperationMetricsService {
  private readonly logger = new Logger(TokenMetricsService.name);
  ...
  private initializeMetrics() {
    ...
    this.tokenOperationByTypeCounter = this.createCounter('auth.token.operations_by_type', {
      description: 'Number of token operations by operation type',
    });

    // Token operation by type histogram
    this.tokenOperationByTypeHistogram = this.createHistogram('auth.token.operations_by_type.duration', {
